...
(function () {
  ...
  global.go = {
    ...
    run: async function (...passed) {
      ...
      let importObject = {
        go: {
          ...
          "syscall/js.Value.set": function (sp) {
            Reflect.set(loadValue(sp + 8), loadString(sp + 16),
              loadValue(sp + 32))
          },
          ...
          "syscall/js.Value.setIndex": function (sp) {
            Reflect.set(loadValue(sp + 8), getInt64(sp + 16),
              loadValue(sp + 24))
          },
      ...
      const strPtr = (str) => {
        let ptr = offset
        new Uint8Array(inst.exports.mem.buffer, offset, str.length + 1).set(
